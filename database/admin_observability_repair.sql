-- Fullet admin observability repair.
-- Run this in Supabase SQL Editor if the admin panel says:
-- "Could not find the table 'public.app_heartbeats' in the schema cache".
